...
const Business = () => {
  return (
    <div className="sm:w-[80%] w-full mx-auto max-sm:px-5 flex items-center gap-40 my-60 max-lg:flex-col">
        <div className="basis-[50%]">
            ...
            <div style={{background: "linear-gradient(158deg, #DEF9FA -43.27%, #BEF3F5 -21.24%, #9DEDF0 12.19%, #7DE7EB 29.82%, #5CE1E6 51.94%, #33BBCF 90.29%)"}} className="text-black flex justify-center items-center text-lg rounded-[10px] w-[170px] h-[64px]">Get Started</div>
        </div>
        <div className="basis-[50%]">
            <ul>
                ...
                <li className='p-5 flex gap-5 items-center main_box'>
                    <span className='basis-16 w-16 h-16 flex justify-center items-center bg-[#09977C1A] rounded-full'>
                    <Image
                    src={shield}
                    alt='shield'
